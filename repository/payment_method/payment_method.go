...
func (ur *PaymentMethodRepository) Insert(newPayMethod pay.Payment_Method) (pay.Payment_Method, error) {
...
// ======================== Get Payment Methods ==================================
func (ur *PaymentMethodRepository) Get() ([]pay.Payment_Method, error) {
	payment_methods := []pay.Payment_Method{}
...
func (ur *PaymentMethodRepository) Update(payment_methodId int, newPayMethod pay.Payment_Method) (pay.Payment_Method, error) {
